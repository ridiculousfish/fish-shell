...
using string_set_t = std::unordered_set<imstring>;

static const imstring skip_keywords[]{
    L"else",
    L"begin",
};

static const imstring subcommand_keywords[]{L"command", L"builtin", L"while", L"exec", L"if",
                                            L"and",     L"or",      L"not",   L"time", L"begin"};

static const string_set_t block_keywords = {L"for",      L"while",  L"if",
                                            L"function", L"switch", L"begin"};

static const imstring reserved_keywords[] = {
