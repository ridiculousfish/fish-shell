...
parser_t::parser_t(std::shared_ptr<env_stack_t> vars,
                   std::shared_ptr<pgid_selector_t> pgid_selector)
...
std::shared_ptr<parser_t> parser_t::branch(const std::shared_ptr<pgid_selector_t> &pg) const {
